...
> ⚠️ УСТАРЕЛО (2026-07-06): Директории отсутствуют в корне, реструктуризация временно приостановлена.

### ✅ [2026-04-13 01:38] [Antigravity]
Более 35 файлов из корня распределены по смысловым папкам.
> ⚠️ УСТАРЕЛО (2026-07-06): Файлы возвращены в корень для упрощения работы агентов.
