...
> ⚠️ УСТАРЕЛО (2026-05-08): Директории отсутствуют в текущей файловой системе, файлы находятся в корне.

### ✅ [2026-04-13 01:38] [Antigravity]
Более 35 файлов из корня распределены по смысловым папкам.
> ⚠️ УСТАРЕЛО (2026-05-08): Файлы по-прежнему находятся в корне репозитория.
...
> ⚠️ УСТАРЕЛО (2026-05-08): KB загружается из корня, так как новая структура директорий отсутствует.
